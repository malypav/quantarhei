...
class ChlorophyllA(MolecularModel, EnergyUnitsManaged):
    ...
    def __init__(self, model_type=None):
        ...
        self.default_energies[1] = 12800.0*cm2int
        self.default_dipole_lengths[0,1] = 4.0
        self.default_dipole_lengths[1,0] = 4.0
...
class ChlorophyllB(MolecularModel, EnergyUnitsManaged):
    ...
    def __init__(self, model_type=None):
        ...
        self.default_energies[1] = 13300.0*cm2int
        self.default_dipole_lengths[0,1] = 3.4
        self.default_dipole_lengths[1,0] = 3.4
